...
namespace ActionCommandGame.Repository
{
    public class ActionButtonGameDbContext: DbContext
    {
        ...
        {
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Personal Blog Defaced", Description = "You deface a personal blog, leaving a message or image on the homepage.", Money = 0, Experience = 5, Probability = 2500, SecurityLoss = 5 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Social Media Account Hacked", Description = "You hack into a social media account, posting unauthorized messages or content.", Money = 0, Experience = 10, Probability = 2475, SecurityLoss = 10 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Email Phishing Campaign", Description = "You conduct an email phishing campaign, attempting to trick individuals into revealing personal information.", Money = 0, Experience = 15, Probability = 2450, SecurityLoss = 15 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Fake Wi-Fi Hotspot Created", Description = "You set up a fake Wi-Fi hotspot, attempting to intercept data from unsuspecting users.", Money = 0, Experience = 20, Probability = 2425, SecurityLoss = 20 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Simple Website Defacement", Description = "You deface a simple website, altering its appearance or content.", Money = 0, Experience = 25, Probability = 2400, SecurityLoss = 25 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Password Guessing Success", Description = "You successfully guess a password for an online account, gaining unauthorized access.", Money = 0, Experience = 30, Probability = 2375, SecurityLoss = 30 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Basic Phishing Website Created", Description = "You create a basic phishing website, attempting to trick users into entering sensitive information.", Money = 0, Experience = 35, Probability = 2350, SecurityLoss = 35 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Simple Social Engineering Attack", Description = "You conduct a simple social engineering attack, manipulating individuals into revealing information or performing actions.", Money = 0, Experience = 40, Probability = 2325, SecurityLoss = 40 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Malicious Browser Extension Installed", Description = "You install a malicious browser extension on a target's computer, potentially compromising their online activity.", Money = 0, Experience = 45, Probability = 2300, SecurityLoss = 45 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Basic Malware Distribution", Description = "You distribute basic malware via email or file sharing, attempting to infect target systems.", Money = 0, Experience = 50, Probability = 2275, SecurityLoss = 50 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Simple SQL Injection Attack", Description = "You execute a simple SQL injection attack on a vulnerable website, attempting to extract data from its database.", Money = 0, Experience = 55, Probability = 2250, SecurityLoss = 55 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Low-Level Network Sniffing", Description = "You conduct low-level network sniffing, capturing and analyzing network traffic.", Money = 0, Experience = 60, Probability = 2225, SecurityLoss = 60 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Basic Firewall Bypass", Description = "You bypass a basic firewall, gaining unauthorized access to a network or system.", Money = 0, Experience = 65, Probability = 2200, SecurityLoss = 65 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Simple Website Vulnerability Exploited", Description = "You exploit a simple vulnerability in a website, gaining unauthorized access or defacing the site.", Money = 0, Experience = 70, Probability = 2175, SecurityLoss = 70 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Minor Data Spoofing", Description = "You spoof minor data in a database or document, attempting to manipulate or deceive users.", Money = 0, Experience = 75, Probability = 2150, SecurityLoss = 75 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Basic Keylogging", Description = "You deploy a basic keylogger on a target system, attempting to capture keystrokes and sensitive information.", Money = 0, Experience = 80, Probability = 2125, SecurityLoss = 80 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Simple Phishing Email Sent", Description = "You send a simple phishing email to a list of targets, attempting to trick them into revealing information or downloading malware.", Money = 0, Experience = 85, Probability = 2100, SecurityLoss = 85 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Minor Website DDoS Attack", Description = "You launch a minor DDoS attack against a website, temporarily disrupting its availability.", Money = 0, Experience = 90, Probability = 2075, SecurityLoss = 90 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Basic Network Port Scanning", Description = "You conduct basic network port scanning, identifying open ports and potential vulnerabilities.", Money = 0, Experience = 95, Probability = 2050, SecurityLoss = 95 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Simple Cross-Site Scripting Attack", Description = "You execute a simple cross-site scripting attack on a vulnerable website, injecting malicious scripts.", Money = 0, Experience = 100, Probability = 2025, SecurityLoss = 100 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Low-Level Software Patching", Description = "You apply low-level software patches to fix known vulnerabilities or security flaws.", Money = 0, Experience = 105, Probability = 2000, SecurityLoss = 105 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Minor System Misconfiguration", Description = "You exploit a minor misconfiguration in a system or application, gaining unauthorized access.", Money = 0, Experience = 110, Probability = 1975, SecurityLoss = 110 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Basic Social Media Impersonation", Description = "You impersonate someone on social media, attempting to deceive others for personal gain or mischief.", Money = 0, Experience = 115, Probability = 1950, SecurityLoss = 115 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Simple Malware Removal", Description = "You remove simple malware infections from a computer system, restoring its functionality.", Money = 0, Experience = 120, Probability = 1925, SecurityLoss = 120 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Minor File Encryption", Description = "You encrypt minor files on a target system, attempting to prevent access or cause inconvenience.", Money = 0, Experience = 125, Probability = 1900, SecurityLoss = 125 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Basic Data Backup", Description = "You perform a basic data backup of important files or documents, ensuring their safety in case of loss or corruption.", Money = 0, Experience = 130, Probability = 1875, SecurityLoss = 130 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Simple Firewall Configuration", Description = "You configure a basic firewall to block certain traffic or protect against known threats.", Money = 0, Experience = 135, Probability = 1850, SecurityLoss = 135 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Low-Level Penetration Testing", Description = "You conduct low-level penetration testing on a target system, identifying common vulnerabilities.", Money = 0, Experience = 140, Probability = 1825, SecurityLoss = 140 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Basic Antivirus Installation", Description = "You install basic antivirus software on a computer system, providing protection against known malware.", Money = 0, Experience = 145, Probability = 1800, SecurityLoss = 145 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Minor System Hardening", Description = "You harden a system by applying minor security measures, such as disabling unnecessary services or tightening access controls.", Money = 0, Experience = 150, Probability = 1775, SecurityLoss = 150 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Simple Data Encryption", Description = "You encrypt simple data on a target system, attempting to protect it from unauthorized access.", Money = 0, Experience = 155, Probability = 1750, SecurityLoss = 155 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Low-Level Network Monitoring", Description = "You monitor network traffic at a low level, identifying potential security threats or anomalies.", Money = 0, Experience = 160, Probability = 1725, SecurityLoss = 160 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Basic Password Management", Description = "You implement basic password management practices, such as using strong passwords and changing them regularly.", Money = 0, Experience = 165, Probability = 1700, SecurityLoss = 165 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Minor Data Loss Prevention", Description = "You implement minor data loss prevention measures, such as restricting access to sensitive information or monitoring data transfers.", Money = 0, Experience = 170, Probability = 1675, SecurityLoss = 170 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Simple Web Application Firewall Setup", Description = "You set up a simple web application firewall to protect against common web-based attacks.", Money = 0, Experience = 175, Probability = 1650, SecurityLoss = 175 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Low-Level Incident Response", Description = "You respond to a minor security incident, such as a malware infection or unauthorized access attempt.", Money = 0, Experience = 180, Probability = 1625, SecurityLoss = 180 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Basic Security Awareness Training", Description = "You provide basic security awareness training to users, educating them about common threats and best practices.", Money = 0, Experience = 185, Probability = 1600, SecurityLoss = 185 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Minor Intrusion Detection Setup", Description = "You set up a minor intrusion detection system to monitor for unauthorized access or suspicious activity.", Money = 0, Experience = 190, Probability = 1575, SecurityLoss = 190 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Simple Network Access Control", Description = "You implement simple network access control measures, such as restricting access based on user roles or device types.", Money = 0, Experience = 195, Probability = 1550, SecurityLoss = 195 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Low-Level Vulnerability Management", Description = "You manage minor vulnerabilities in a system or application, applying patches or workarounds to mitigate risk.", Money = 0, Experience = 200, Probability = 1525, SecurityLoss = 200 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Basic Security Policy Development", Description = "You develop basic security policies for an organization, outlining guidelines and procedures for protecting information assets.", Money = 0, Experience = 205, Probability = 1500, SecurityLoss = 205 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Minor Risk Assessment", Description = "You conduct a minor risk assessment, identifying and prioritizing potential security risks to an organization.", Money = 0, Experience = 210, Probability = 1475, SecurityLoss = 210 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Simple Security Audit", Description = "You perform a simple security audit of a system or network, identifying potential vulnerabilities or compliance issues.", Money = 0, Experience = 215, Probability = 1450, SecurityLoss = 215 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Low-Level Security Incident Analysis", Description = "You analyze a low-level security incident, investigating the cause and impact of the event.", Money = 0, Experience = 220, Probability = 1425, SecurityLoss = 220 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Basic Threat Intelligence Gathering", Description = "You gather basic threat intelligence, monitoring for potential security threats or trends.", Money = 0, Experience = 225, Probability = 1400, SecurityLoss = 225 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Minor Security Compliance Check", Description = "You conduct a minor security compliance check, ensuring that systems and processes adhere to regulatory requirements.", Money = 0, Experience = 230, Probability = 1375, SecurityLoss = 230 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Simple Security Awareness Campaign", Description = "You launch a simple security awareness campaign, educating users about common threats and best practices.", Money = 0, Experience = 235, Probability = 1350, SecurityLoss = 235 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Low-Level Security Architecture Review", Description = "You review the security architecture of a system or network at a low level, identifying potential weaknesses or areas for improvement.", Money = 0, Experience = 240, Probability = 1325, SecurityLoss = 240 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Basic Security Controls Implementation", Description = "You implement basic security controls, such as encryption, access controls, and logging, to protect information assets.", Money = 0, Experience = 245, Probability = 1300, SecurityLoss = 245 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Minor Security Incident Response", Description = "You respond to a minor security incident, containing and mitigating its impact on an organization.", Money = 0, Experience = 250, Probability = 1275, SecurityLoss = 250 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Simple Security Training Session", Description = "You conduct a simple security training session for employees, covering basic security principles and best practices.", Money = 0, Experience = 255, Probability = 1250, SecurityLoss = 255 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Low-Level Security Monitoring", Description = "You monitor security events and alerts at a low level, identifying potential threats or anomalies in real-time.", Money = 0, Experience = 260, Probability = 1225, SecurityLoss = 260 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Basic Security Incident Reporting", Description = "You report a basic security incident to relevant stakeholders, providing details and recommendations for remediation.", Money = 0, Experience = 265, Probability = 1200, SecurityLoss = 265 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Minor Security Policy Review", Description = "You review a minor security policy or procedure, ensuring that it aligns with organizational goals and best practices.", Money = 0, Experience = 270, Probability = 1175, SecurityLoss = 270 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Simple Security Risk Mitigation", Description = "You mitigate a simple security risk, implementing controls or countermeasures to reduce its likelihood or impact.", Money = 0, Experience = 275, Probability = 1150, SecurityLoss = 275 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Low-Level Security Incident Investigation", Description = "You investigate a low-level security incident, gathering evidence and analyzing data to determine the cause and impact of the event.", Money = 0, Experience = 280, Probability = 1125, SecurityLoss = 280 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Basic Security Awareness Workshop", Description = "You facilitate a basic security awareness workshop for employees, engaging them in discussions and activities to improve their security awareness.", Money = 0, Experience = 285, Probability = 1100, SecurityLoss = 285 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Minor Security Policy Development", Description = "You develop a minor security policy or procedure, outlining guidelines and best practices for protecting information assets.", Money = 0, Experience = 290, Probability = 1075, SecurityLoss = 290 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Simple Security Controls Review", Description = "You review simple security controls, ensuring that they are effectively implemented and aligned with organizational objectives.", Money = 0, Experience = 295, Probability = 1050, SecurityLoss = 295 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Low-Level Security Incident Management", Description = "You manage a low-level security incident, coordinating response efforts and communicating with relevant stakeholders.", Money = 0, Experience = 300, Probability = 1025, SecurityLoss = 300 });
            PositiveGameEvents.Add(new PositiveGameEvent { Name = "Basic Security Strategy Development", Description = "You develop a basic security strategy for an organization, outlining long-term goals and priorities for improving security posture.", Money = 0, Experience = 305, Probability = 1000, SecurityLoss = 305 });
